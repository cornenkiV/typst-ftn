...
Ова имплементација је директна и меморијски ефикасна и демонстрира рачунарски напор потребан за проналажење решења у _Proof-of-Work_ систему. Њено извођење чини основу за процену
ефикасности паралелне имплементације.
