...
#let naslov = "Паралелизација PоW и PоS блокчејн консензус алгоритма у оквиру децентрализованог P2P система"
...
#let zadatak = [
    Истражити област блокчејн консензус алгоритама. Пројективати и имплементирати
    блокчејн систем са фокусом на паралелизацију Proof-Of-Work и Proof-Of-Stake
    консензус алгоритама. Испитати скалабилност паралелних имплементација на
    програмским језицима Rust и Python.
